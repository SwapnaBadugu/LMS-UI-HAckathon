...
public class Classes {
	...
	public void created_classwill_be_displayed_in_manage_classes_page_admin() {
		...
		Assert.assertEquals(clasDis,
				"All the existing Classes details are displayed in Manage Classes Page\\\\(Admin)");
	...
	public void updated_class_details_will_be_displayedin_manage_classes_page_admin() {
		...
		// Assert.assertEquals(displaydet,"Updated Class details will be displayedin
		// Manage Classes Page\\\\(admin)");
